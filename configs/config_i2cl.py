...
config = {}
# general
# config['exp_name'] = 'exps/kmeans_cls_5_shot_20'
config['exp_name'] = 'exps/debug_0827'
config['gpus'] = ['0']
...
config['inject_method'] = 'clustering'  # 'linear', 'constraint', 'add'
...
config['post_fuse_method'] = 'kmeans'  # 'mean', 'pca'
...
# data
config['shot_per_class'] = 20  # number of shots per class
